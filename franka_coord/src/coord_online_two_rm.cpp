    ...
    {       
      ...
      {        
        ...
        if (qi_goal_t > qi_goal_r2)
        {
          ...
          {
            ROS_INFO("[COORD(R%d,R%d)] R%d temp goal updated to %d.",pair_ir[0],pair_ir[1],pair_ir[1],qi_goal_r2);
            // std::cout << q_goal_r2 << " "
    ...
    {       
      ...
      {        
        ...
        if (qi_goal_t > qi_goal_r1)
        {
          ...
          if (client_update_goal.call(srv_para))
          {
            ROS_INFO("[COORD(R%d,R%d)] R%d temp goal updated to %d.",pair_ir[0],pair_ir[1],pair_ir[0],qi_goal_r1);
            // std::cout << q_goal_r2 << " "
            //     << srv_para.request.qgoalt2[0] << " "
            //     << srv_para.request.qgoalt2[1] << " "
            //     << srv_para.request.qgoalt2[2] << " "
