              ...
              franka_coord::GiveGoal::Response &res)
{
  ...
  filecm.open ("/home/frankanuc03/Documents/Coordination/collision_matrix.txt");
  fileboundary1.open ("/home/frankanuc03/Documents/Coordination/boundary_r1.txt");
  ...
  if (robotid_r1 && robotid_r2 && (change_goal_r1 || change_goal_r2))
  {
    ...
    // std::cout << "Minimal motion time: " << tf_min_r1 << ", " << tf_min_r2 << std::endl;
    ...
    // while ((num_collision > 0) && (deadlock == 0))
    {
    // 1.1 - R1
    ...
    while (!motion_finished_r1) {
      ...
      for (franka::Frame frame = franka::Frame::kJoint1; frame <= franka::Frame::kEndEffector; frame++) {   
        std::array<double, 16> pose_cartesian = model.pose(frame, motion_generation_r1.q_current, T_F_EE, T_EE_K);
        position_cartesian_r1(count_link*3+0, sample_count_r1) = pose_cartesian[12] + base_position_r1[0];
        position_cartesian_r1(count_link*3+1, sample_count_r1) = pose_cartesian[13] + base_position_r1[1];
        position_cartesian_r1(count_link*3+2, sample_count_r1) = pose_cartesian[14] + base_position_r1[2];
        count_link += 1;
      }
    ...
    while (!motion_finished_r2) {
      ...
      int count_link = 0;
      for (franka::Frame frame = franka::Frame::kJoint1; frame <= franka::Frame::kEndEffector; frame++) {   
        std::array<double, 16> pose_cartesian = model.pose(frame, motion_generation_r2.q_current, T_F_EE, T_EE_K);
        position_cartesian_r2(count_link*3+0, sample_count_r2) = pose_cartesian[12] + base_position_r2[0];
        position_cartesian_r2(count_link*3+1, sample_count_r2) = pose_cartesian[13] + base_position_r2[1];
        position_cartesian_r2(count_link*3+2, sample_count_r2) = pose_cartesian[14] + base_position_r2[2];
        count_link += 1;
      }
    ...
    std::ofstream filecm;
    filecm.open ("/home/frankanuc03/Documents/Coordination/CM_"+std::to_string(pair_ir[0])+"_"+std::to_string(pair_ir[1])+".txt");
    for (size_t i_sample_r1 = 0; i_sample_r1 < sample_size_r1; ++i_sample_r1)
    {
      for (size_t i_sample_r2 = 0; i_sample_r2 < sample_size_r2; ++i_sample_r2)
      {
